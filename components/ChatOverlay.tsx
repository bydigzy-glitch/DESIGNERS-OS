      ...
      >
        <div className="p-4 border-b border-border flex justify-between items-center bg-card flex-shrink-0">
          <div className="flex items-center gap-2 text-foreground">
            ...
            <h2 className="text-lg font-bold">Assist</h2>
          </div>
          <button onClick={onClose} className="p-2 hover:bg-secondary rounded-lg text-muted-foreground hover:text-foreground" aria-label="Close AI Assistant">
            <X size={20} />
          </button>
        </div>
