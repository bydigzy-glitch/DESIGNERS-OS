  ...
  return (
    <FadeIn className="flex flex-col h-full w-full overflow-y-auto pb-20 md:pb-0 scrollbar-hide space-y-8 pr-2">
       ...
       <div className="flex justify-between items-end">
           ...
           <button onClick={() => setIsModalOpen(true)} className="bg-primary text-primary-foreground px-4 py-2 rounded-xl font-bold text-sm flex items-center gap-2 hover:bg-primary/90 transition-colors">
               ...
               {habits.map(habit => {
                   ...
                   return (
                       <div key={habit.id} className="p-4 flex items-center justify-between hover:bg-secondary/20 transition-colors group">
                           ...
                           <button onClick={() => deleteHabit(habit.id)} className="p-2 text-muted-foreground hover:text-red-500 hover:bg-red-500/10 rounded-lg opacity-0 group-hover:opacity-100 transition-all">
                               <Trash2 size={18} />
                           </button>
                       </div>
                   );
               ...
               <div 
                ...
                >
                   <div className="flex justify-between items-center mb-6">
                       ...
                       <button onClick={closeModal} className="p-2 hover:bg-secondary rounded-full transition-colors"><X size={20} /></button>
                   </div>
