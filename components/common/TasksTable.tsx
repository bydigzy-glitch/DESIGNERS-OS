                                    ...
                                    <div className="col-span-1 flex justify-center">
                                        {assignee ? (
                                            <div className="relative group/avatar">
                                                <img src={assignee.avatar || `https://api.dicebear.com/7.x/avataaars/svg?seed=${assignee.email}`} className="w-6 h-6 rounded-full bg-secondary object-cover border border-border" />
                                                <span className="absolute bottom-full mb-1 left-1/2 -translate-x-1/2 bg-black text-white text-[10px] px-1.5 py-0.5 rounded opacity-0 group-hover/avatar:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
