...
export const ProjectModal: React.FC<ProjectModalProps> = ({ 
  ...
  }, [initialProject, isOpen, allTasks]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in">
      <div className="bg-[#141416] border border-gray-800 rounded-3xl w-full max-w-lg shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
        <div className="p-6 border-b border-white/5 flex justify-between items-center shrink-0">
          ...
          <div className="flex items-center gap-2">
            {initialProject && onDelete && (
              <button onClick={() => { onDelete(initialProject.id); onClose(); }} className="p-2 text-red-400 hover:bg-red-500/10 rounded-xl transition-colors">
                <Trash2 size={18} />
              </button>
            )}
