...
import { X, Calendar as CalendarIcon, Clock, Trash2, FileText, Plus, Check } from 'lucide-react';
                ...
                <div>
                  ...
                  <div className="relative">
                    <select 
                      ...
                      className={`w-full bg-black/50 border border-white/10 rounded-xl p-3 text-sm focus:outline-none focus:border-accent-primary appearance-none font-bold ${
